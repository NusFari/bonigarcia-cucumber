...
public class GalaxyWatch extends NavigationBar{
    private final By All=By.id("ALL");

    //private final By SaveUp = By.xpath("//h1[contains(text(),'Save up to ')]");
    private static final Logger LOGGER= LogManager.getLogger(GalaxyWatch.class);

    public GalaxyWatch (WebDriver driver) {
        super(driver);
    }
