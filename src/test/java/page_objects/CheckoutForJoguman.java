...
public class CheckoutForJoguman extends NavigationBar {
    private final By EstimatedTotal = By.xpath("//div[5]/p[1][contains(text(),'Estimated total')]");
    private static final Logger LOGGER = LogManager.getLogger(CheckoutForJoguman.class);

    public CheckoutForJoguman(WebDriver driver) {
        super(driver);
    }

    public CheckoutForJoguman validateEstimatedTotal(String expectedEstimatedTotal) {
