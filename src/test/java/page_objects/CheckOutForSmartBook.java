...
public class CheckOutForSmartBook extends NavigationBar {
    private final By EstimatedTotal = By.xpath("//div[5]/p[1][contains(text(),'Estimated total')]");
    private static final Logger LOGGER = LogManager.getLogger(CheckOutForSmartBook.class);

    public CheckOutForSmartBook(WebDriver driver) {
        super(driver);
    }

    public CheckOutForSmartBook validateEstimatedTotal(String expectedEstimatedTotal) {
