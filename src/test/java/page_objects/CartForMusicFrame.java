...
import org.openqa.selenium.WebDriver;
    ...
    public class CartForMusicFrame extends NavigationBar {
        private final By EstimatedTotal = By.xpath("//div[5]/p[1][contains(text(),'Estimated total')]");
        private static final Logger LOGGER = LogManager.getLogger(CartForMusicFrame.class);

        public CartForMusicFrame(WebDriver driver) {
            super(driver);
        }

        public CartForMusicFrame validateEstimatedTotal(String expectedEstimatedTotal) {
